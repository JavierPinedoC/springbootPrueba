...
# Add Maintainer Info
LABEL maintainer="a01551344@itesm.mx"
...
ADD ${JAR_FILE} postgres-demo-0.0.1.jar

# Run the jar file 
ENTRYPOINT ["java","-Djava.security.egd=file:/dev/./urandom","-jar","/postgres-demo-0.0.1.jar"]
